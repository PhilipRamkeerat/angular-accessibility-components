...
export class KeyboardManagerDirective {
  ...
  // Inject keyboardManagedItemDirective items to KeyboardManagedItemDirective
  ...
  public moveFocus(direction: ArrowDirection): KeyboardManagedItemDirective {
    ...
    const targetElementFocus = items[currentSelectedIndex + direction]; // +1 or -1 to move by keyboard
